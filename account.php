...
<?php endif ?>
    ...
    <a class="logo" href="index.php"> <img src="images/logo.jpg">  </a>
    	 ...
    	 <strong><?php echo $_SESSION['username']; ?>, Welcome To Your UNI BOOK Account! </strong>
...
<tr>
<td colspan="2" align="left" style="font-weight:bold; font-size:20px; color:red; font-family:cursive">Your Total collage fee (LKR):</td>
...
?>
 ...
 <script>
     function mycheckout() { 
         alert("Your payment has been received. Check your email to receive collage fee receipt");
     }	
 </script>
 ...
 <div class="footer">
        <div class="footer-left">
            ...
            <i class="fa fa-envelope" style=" font-size:15px"> </i> UNI BOOK
        </div>
